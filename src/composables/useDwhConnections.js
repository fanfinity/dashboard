...
export const CONNECTION_TYPES = [
  {
    ...
    label: 'Snowflake',
    description:
      'Account host plus a service user. Fanfinity reads modelled tables and writes audience snapshots back.',
    defaultPort: 443,
    ...
    usernamePlaceholder: 'FANFINITY_SVC',
  ...
  },
  {
    ...
    databasePlaceholder: 'fanfinity-archive',
  ...
  },
  {
    ...
    usernamePlaceholder: 'fanfinity-svc',
  ...
  },
  {
    ...
    defaultPort: 5432,
    hostLabel: 'Host',
    hostPlaceholder: 'crm-db.internal.fanfinity.io',
    databaseLabel: 'Database',
    databasePlaceholder: 'crm',
    usernameLabel: 'Username',
    usernamePlaceholder: 'fanfinity_ro',
    secretLabel: 'Password',
    schemaPlaceholder: 'public'
  },
  {
