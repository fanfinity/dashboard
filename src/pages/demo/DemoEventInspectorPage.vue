<template>
  <q-page class="p-6">
    <PageHeader title="Demo Event Inspector" subtitle="/demo-event-inspector" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #26.
...
const description =
  'This screen is tracked by issue #26 and has not been implemented yet.'
</script>
