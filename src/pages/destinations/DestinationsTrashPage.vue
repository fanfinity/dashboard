<template>
  <q-page class="p-6">
    <PageHeader title="Destinations" subtitle="/destinations/trash" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #31.
...
const description =
  'This screen is tracked by issue #31 and has not been implemented yet.'
</script>
