<template>
  <q-page class="p-6">
    <PageHeader title="Profile DWH Syncs" subtitle="/profile-dwh-syncs/trash" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #56.
...
const description =
  'This screen is tracked by issue #56 and has not been implemented yet.'
</script>
