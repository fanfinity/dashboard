<template>
  <q-page class="p-6">
    <PageHeader title="Live Profile Syncs" subtitle="/live-profile-syncs" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #44.
...
const description =
  'This screen is tracked by issue #44 and has not been implemented yet.'
</script>
