<template>
  <q-page class="p-6">
    <PageHeader title="Profiles" subtitle="/profiles/identity-resolution" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #57.
...
const description =
  'This screen is tracked by issue #57 and has not been implemented yet.'
</script>
