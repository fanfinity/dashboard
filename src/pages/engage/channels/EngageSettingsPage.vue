<template>
  <q-page class="p-6">
    <PageHeader title="Engage Settings" subtitle="/engage-settings" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #39.
...
const description =
  'This screen is tracked by issue #39 and has not been implemented yet.'
</script>
