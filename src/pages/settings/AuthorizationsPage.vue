<template>
  <q-page class="p-6">
    <PageHeader title="Authorizations" subtitle="/authorizations" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #22.
...
const description =
  'This screen is tracked by issue #22 and has not been implemented yet.'
</script>
