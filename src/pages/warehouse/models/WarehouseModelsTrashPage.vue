<template>
  <q-page class="p-6">
    <PageHeader title="Warehouse Models" subtitle="/warehouse-models/trash" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #69.
...
const description =
  'This screen is tracked by issue #69 and has not been implemented yet.'
</script>
