<template>
  <q-page class="p-6">
    <PageHeader title="DWH Connections" subtitle="/dwh-connections/trash" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #34.
...
const description =
  'This screen is tracked by issue #34 and has not been implemented yet.'
</script>
