<template>
  <q-page class="p-6">
    <PageHeader title="DWH Connections" subtitle="/dwh-connections" />
    <EmptyState title="Not built yet" :description="description" />
  </q-page>
</template>

<script setup>
// STUB — implemented by issue #32.
...
const description =
  'This screen is tracked by issue #32 and has not been implemented yet.'
</script>
