...
| [Material Symbols Outlined](https://fonts.google.com/icons?icon.style=Outlined) | CDN v347 | `material-symbols-outlined` | Material symbols outlined font                       | Requires: @quasar/extras 1.14+ | [License](exports/material-symbols-outlined/LICENSE) |
| [Material Symbols Rounded](https://fonts.google.com/icons?icon.style=Rounded)   | CDN v349 | `material-symbols-rounded`  | Material symbols rounded font                        | Requires: @quasar/extras 1.14+ | [License](exports/material-symbols-rounded/LICENSE)  |
| [Material Symbols Sharp](https://fonts.google.com/icons?icon.style=Sharp)       | CDN v345 | `material-symbols-sharp`    | Material symbols sharp font                          | Requires: @quasar/extras 1.14+ | [License](exports/material-symbols-sharp/LICENSE)    |
...
| [Material Symbols Outlined](https://fonts.google.com/icons?icon.style=Outlined) (Google) | CDN v347 | `svg-material-symbols-outlined` | `@quasar/extras/material-symbols-outlined` | Requires: @quasar/extras 1.14+                            | [License](exports/material-symbols-outlined/LICENSE) |
| [Material Symbols Rounded](https://fonts.google.com/icons?icon.style=Rounded) (Google)   | CDN v349 | `svg-material-symbols-rounded`  | `@quasar/extras/material-symbols-rounded`  | Requires: @quasar/extras 1.14+                            | [License](exports/material-symbols-rounded/LICENSE)  |
| [Material Symbols Sharp](https://fonts.google.com/icons?icon.style=Sharp) (Google)       | CDN v345 | `svg-material-symbols-sharp`    | `@quasar/extras/material-symbols-sharp`    | Requires: @quasar/extras 1.14+                            | [License](exports/material-symbols-sharp/LICENSE)    |
